...
const Card = ({name, lafadz, arti, index, onClick, ...res}) => {
    return (
        <div onClick={onClick} className={classNames("bg-white duration-300 dark:bg-gray-700 dark:text-gray-50 text-gray-900 h-28 md:h-36 p-3 rounded-md hover:shadow-lg transition-all font-poppins flex flex-col justify-between")}>
            ...
            <div className="flex justify-between items-center">
                ...
                <div>
                    <a className="text-3xl lg:text-4xl font-serif">{lafadz}</a>
                </div>
            </div>
        </div>
    )
